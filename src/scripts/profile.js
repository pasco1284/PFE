...
function goBack() {
    ...
    if (previousPage === 'http://57.129.134.101:49152/etudiant') {
        window.location.href = 'http://57.129.134.101:49152/etudiant';
    } else if (previousPage === 'http://57.129.134.101:49152/enseignant') {
        window.location.href = 'http://57.129.134.101:49152/enseignant';
    } else {
        window.location.href = 'http://57.129.134.101:49152/home';  
    }
}
